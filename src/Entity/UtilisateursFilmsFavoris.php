...
use App\Repository\UtilisateursFilmsFavorisRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: UtilisateursFilmsFavorisRepository::class)]
class UtilisateursFilmsFavoris
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
